...
import {
  LayoutDashboard, TrendingDown, PhoneCall,
  BarChart3, ShieldAlert, Layers, Activity,
} from 'lucide-react'
...
export default function Sidebar() {
  return (
    <aside className="fixed left-0 top-0 h-screen w-56 flex flex-col glass-sidebar z-40">
      ...
      <div className="px-5 py-6" style={{ borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
        <div className="flex items-center gap-2.5">
          <div
            ...
            style={{
              background: '#00c9a7',
              boxShadow: '0 0 16px rgba(0,201,167,0.55)',
            }}
          >
          ...
          >
            {({ isActive }) => (
              <>
                ...
                {isActive && (
                  <span
                    className="ml-auto w-1.5 h-1.5 rounded-full live-dot"
